  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-16 right-10 z-50 bg-whatsapp text-on-primary p-5 rounded-full shadow-2xl flex items-center gap-2 overflow-hidden max-w-[64px] hover:max-w-[200px] transition-all duration-500 hover:scale-105 active:scale-95 group"
      >
